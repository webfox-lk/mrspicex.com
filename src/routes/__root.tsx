...
import { InquiryProvider } from "@/components/site/InquiryProvider";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        title: "M.R SPICE EXPORT (PVT) LTD | Sri Lankan Whole Spice Exporter",
      },
      {
        name: "description",
        content:
          "Premium Sri Lankan whole spices exported worldwide in bulk to importers, wholesalers, distributors and food manufacturers.",
      },
      { name: "author", content: "M.R SPICE EXPORT (PVT) LTD" },
      { property: "og:site_name", content: "M.R SPICE EXPORT (PVT) LTD" },
